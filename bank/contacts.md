...
| Name | Phone | WhatsApp Name | Notes |
|------|-------|---------------|-------|
| Oscar Serra | +34 659 418 105 | — | Owner |
| Sasha | +1 408 497 5095 | "Sasha" | Wife (US number) |
...
| Name | Role | Contact |
|------|------|---------|
| Ramón Serra | Founder, "El Capità" | — |
| Dolors Ruiz | Financial Manager | — |
| Sara | Admin/Sales | — |
| Xavier | Developer (part-time) | — |

## 🔗 References
- Family profiles: [Serra-Family.md](entities/Serra-Family.md)
