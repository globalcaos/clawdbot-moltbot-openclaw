    ...
    "openclaw":
      {
        "emoji": "🗺️",
        "os": ["linux", "darwin"],
        "requires": { "skills": ["agent-memory-ultimate"] },
        "notes":
          {
...
Without benchmarks, your agent's memory is just vibes. _"I'm pretty sure the user mentioned something important once"_ is not a retrieval strategy.
