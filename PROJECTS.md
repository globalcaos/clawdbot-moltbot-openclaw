...
| 17  | 🐛 Bug     | —      | —             | **Queued messages not visible** — Messages added to queue don't appear in the UI queue display (reported 2026-02-03)                                                                                                      | —                                   | openclaw/openclaw   | `ui/src/ui/`                                               | 🔍 To investigate | ❓ No      |
| 18  | 🐛 Bug     | —      | —             | **Queued messages not engaging** — Sometimes queued messages fail to execute/engage after the current run completes (reported 2026-02-02)                                                                                 | —                                   | openclaw/openclaw   | `ui/src/ui/app-chat.ts`                                    | 🔍 To investigate | ❓ No      |
| 19  | 🐛 Bug     | #6853  | —             | **Webchat /new bypasses hooks** — TUI/webchat `/new` command uses sessions.reset RPC which bypasses internal hook dispatch (session-memory etc never fire)                                                                | —                                   | openclaw/openclaw   | `src/gateway/server-methods/sessions.ts`                   | 🔍 From upstream | ❓ No      |
